package org.roubinet.librarie.infrastructure.adapter.in.rest.v1.admin;
...
/**
 * Admin REST controller for book management operations.
 * Implements CRUD operations for administrative access.
 * Version 1 API following REST best practices.
 */
@Path("/v1/admin/books")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@Tag(name = "Admin Books", description = "Administrative book management operations")
public class AdminBooksController {
    ...
    @Inject
    public AdminBooksController(BookUseCase bookUseCase,
    ...
    @GET
    @Operation(summary = "Get all books with cursor-based pagination", description = "Retrieve all books using keyset pagination for admin access")
    @APIResponses(value = {
