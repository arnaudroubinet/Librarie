...
/**
 * Domain model representing entity counts in the library system.
 */
public class EntityCounts {
    ...
    public EntityCounts(long books, long series, long authors, long publishers, long languages, long formats) {
        this.books = books;
        this.series = series;
